    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // shift the car perspective by 90 degree
          // now we only need to consider x = 0, y = 0, psi = 0
          ...
          double* ptrx = &ptsx[0];
          double* ptry = &ptsy[0];
          Eigen::Map<Eigen::VectorXd> ptsx_Xd(ptrx, 6);
          Eigen::Map<Eigen::VectorXd> ptsy_Xd(ptry, 6);
